    ...
    return (
        <Button
            ...
            className={`relative rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-slate-50 shadow-sm border-0 ring-1 ring-inset ring-indigo-300 overflow-hidden
              ...
              before:rounded-md
              before:bg-[linear-gradient(60deg,#4f46e5_20.8%,#d946ef_94.3%)]
...
const StyledBtn2: FC<Tprops> = ({
    ...
    return (
        <Button
            ...
            value={value}
            disabled={disabled}
            className={`relative rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-slate-200 shadow-sm border-0 ring-1 ring-inset ring-indigo-300
