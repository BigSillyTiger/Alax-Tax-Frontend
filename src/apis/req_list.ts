...
export const WL_SINGLE_UPDATE_N_D = "/api/work/single-update-n-d"; // note / deduction
export const WL_SINGLE_UPDATE_H_N_D = "/api/work/single-update-h-n-d"; // hours / note / deduction
