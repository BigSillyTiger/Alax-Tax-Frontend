    ...
    return data.map((item, i) => {
        return (
            ...
            >
                <View
                    style={tw(
                        "text-sm w-[250pt] my-auto pl-3 text-wrap break-all"
                    )}
                >
                    <Text
                        style={tw(
                            "text-sm w-[250pt] my-auto pl-1  text-wrap break-all"
                        )}
                    >
                        {item.title}
                    </Text>
                    {item.description && (
                        <Text
                            style={tw(
                                "text-sm w-[250pt] my-auto pl-3 text-gray-500  text-wrap break-all"
                            )}
                        >
                            {item.description}
                        </Text>
