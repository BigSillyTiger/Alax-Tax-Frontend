    ...
    const navFocus = ({
        ...
        return `
            ...
            ${
                ...
                before:coutent-[''] before:absolute before:bg-transparent before:rounded-br-3xl
                before:shadow-[15px_0_0_rgba(241,245,249,1)] before:w-full before:h-4 ${topPsedo[index]} before:right-0 before:z-50 
                after:coutent-[''] after:absolute after:bg-transparent after:rounded-tr-3xl
    ...
    return (
        ...
        >
            <div className="flex h-16 shrink-0 items-center justify-center">
                <img className="h-8 w-auto" src={logoSrc} alt="Company icon" />
            </div>
            <nav className="mt-8">
